...
public class ReservaHabitacion {
    ...
    public ReservaHabitacion(int id, int idHuesped, int idHabitacion, Date fechaHoraReserva, Date fechaHoraLlegada, Date fechaHoraSalida, Date fechaHoraCheckIn, Date fechaHoraCheckOut, String estado, String estadoServicio) {
        this.id = id;
